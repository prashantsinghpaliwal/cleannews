...
import me.prashant.cleannews.domain.usecase.SearchNewsUseCase
    ...
    constructor(
        ...
        fun searchNews(
            ...
            viewModelScope.launch {
                ...
                searchNewsUseCase(queryString, currentPage)
                    .catch { e ->
                        _state.value =
                            ArticleListState.Error(e.message ?: "An error occurred")
                    }.collect { result ->
                        when (result) {
                            is Resource.Loading ->
                                _state.value =
